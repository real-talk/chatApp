...
export declare function concat(...args: string[]): string;
export declare function defineMaybe(options: Handlebars.HelperOptions): string;
export declare function useMaybe(type: string): string;
export declare function getScalarType(type: string, options: Handlebars.HelperOptions): any;
export declare function importEnum(name: string, options: Handlebars.HelperOptions): {
    name: string;
    file: any;
    type: any;
} | {

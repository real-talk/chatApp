        ...
        return new Promise(function (resolve, reject) {
            glob(documentGlob, function (err, files) {
                ...
                if (!files || files.length === 0) {
                    graphql_codegen_core_1.debugLog("[Document Loader] No files matched for glob expression: " + documentGlob);
    ...
    DocumentsFromGlob.prototype.handle = function (doc, config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        graphql_codegen_core_1.debugLog("[Document Loader] Handling " + doc);
                        return [4 /*yield*/, this.documentsFromGlobs(doc)];
                    case 1:
